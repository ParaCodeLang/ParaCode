...
class BuiltInFunction(BaseFunction):
  ...
  def execute_debuglog(self, exec_ctx):
    print("Debug.Log: " + str(exec_ctx.symbol_table.get('value')))
    return RTResult().success(Number.null)
  execute_debuglog.arg_names = ['value']

  def execute_debugwarning(self, exec_ctx):
    print("Debug.Warning: " + str(exec_ctx.symbol_table.get('value')))
    return RTResult().success(Number.null)
  execute_debugwarning.arg_names = ['value']

  def execute_debugerror(self, exec_ctx):
    print("Debug.Error: " + str(exec_ctx.symbol_table.get('value')))
    return RTResult().success(Number.null)
  ...
  def execute_Import(self, exec_ctx):
    if os.path.exists(str(exec_ctx.symbol_table.get('value'))) and os.path.exists(str(exec_ctx.symbol_table.get('value2'))):
        value3 = os.open(str(exec_ctx.symbol_table.get('value')), "w+") + "\n\n\n" + os.open(str(exec_ctx.symbol_table.get('value2')), "w+")
...
global_symbol_table.set("IMAGE", tk.Image)
global_symbol_table.set("LABEL", tk.Label)
