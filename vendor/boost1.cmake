...
set(BoostVersion 1.78.0)
set(BoostSHA1 7ccc47e82926be693810a687015ddc490b49296d)
...
if(NOT IS_DIRECTORY "${BoostCacheDir}")
  if(BOOST_CACHE_DIR)
    ...
    set(Message "${Message}  Falling back to default path at \"${CMAKE_BINARY_DIR}\"\n")
    message(WARNING "${Message}")
  endif()
  set(BoostCacheDir ${CMAKE_BINARY_DIR})
else()
  if(NOT USE_BOOST_CACHE AND NOT BOOST_CACHE_DIR)
    set(BoostCacheDir "${BoostCacheDir}")
  endif()
...
if(WIN32)
  ...
  if(BoostSourceDirLength GREATER "130")
    ...
    set(Msg "${Msg}  mkdir C:\\boost\n")
    set(Msg "${Msg}  cmake . -DUSE_BOOST_CACHE=ON -DBOOST_CACHE_DIR=C:\\boost\n\n")
...
#   message(FATAL_ERROR "Remove patched files from the source tree and delete corresponding 'configure_file' commands in this 'boost' CMake file.")
# endif()
...
add_dependencies(boost_algorithm boost_system)
...
#==================================================================================================#
if(MSVC)
  foreach(BoostLib BoostChrono BoostDateTime BoostFilesystem BoostLocale BoostProgramOptions BoostRegex BoostSystem BoostThread BoostAlgorithm)
...
install(DIRECTORY ${BoostSourceDir}/boost COMPONENT Development DESTINATION include/third_party_libs)
